...
init(Parent,Display,PWin,X,Y,Figure) ->
    ...
    xFlush(Display),        
    Black = xCreateGC(Display, [{line_width,20},{foreground, xColor(Display, 16#000000)}]),  
    draw_figure(Display,Win,Black,Figure),
    xFlush(Display),
    Red0 = xCreateGC(Display, [{line_width,10},{foreground, xColor(Display, 16#500000)}]),
    Red1 = xCreateGC(Display, [{line_width,10},{foreground, xColor(Display, 16#600000)}]),
    Red2 = xCreateGC(Display, [{line_width,10},{foreground, xColor(Display, 16#700000)}]),
    Red3 = xCreateGC(Display, [{line_width,10},{foreground, xColor(Display, 16#800000)}]),
    Red4 = xCreateGC(Display, [{line_width,10},{foreground, xColor(Display, 16#900000)}]),	
    Red5 = xCreateGC(Display, [{line_width,10},{foreground, xColor(Display, 16#A00000)}]),
    Red6 = xCreateGC(Display, [{line_width,10},{foreground, xColor(Display, 16#B00000)}]),
    Red7 = xCreateGC(Display, [{line_width,10},{foreground, xColor(Display, 16#C00000)}]),
    Red8 = xCreateGC(Display, [{line_width,10},{foreground, xColor(Display, 16#D00000)}]),
    Red9 = xCreateGC(Display, [{line_width,10},{foreground, xColor(Display, 16#E00000)}]),
    Red10 = xCreateGC(Display, [{line_width,10},{foreground, xColor(Display, 16#FF0000)}]),
