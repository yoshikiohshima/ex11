...
init(Parent,Display,PWin,X,Y,Figure) ->
    ...
    xFlush(Display),        
    Black = xCreateGC(Display, [{function,copy},{plane_mask,16#00000001},{line_width,20},{foreground, xColor(Display, 16#000000)}]),  
    BlingGC = xCreateGC(Display, [{function,copy},{line_width,20},{foreground, xColor(Display, 16#000000)}]),  
