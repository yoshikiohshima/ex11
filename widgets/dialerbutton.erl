...
init(Parent,Display,PWin,X,Y,Figure) ->
    ...
    Red5 = xCreateGC(Display, [{line_width,20},{foreground, xColor(Display, 16#A00000)}]),
    Red6 = xCreateGC(Display, [{line_width,20},{foreground, xColor(Display, 16#B00000)}]),
    Red7 = xCreateGC(Display, [{line_width,20},{foreground, xColor(Display, 16#C00000)}]),
    Red8 = xCreateGC(Display, [{line_width,20},{foreground, xColor(Display, 16#D00000)}]),
    ...
    Redlist = [Red0,Red1,Red2,Red3,Red4,Red5],
